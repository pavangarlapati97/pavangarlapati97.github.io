...
<b><u>Airline Ticket Reservation For A Trip</u></b></font><!--mstheme--></font></h1>
...
<form method="POST" action="insert2.jsp">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  sex&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input type="radio" value="sex" checked name="R1">M&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input type="radio" name="sex" value="V2">F</p>
  <p>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<% for( int  i = 1 ; i <= 12; i++)
 ...
 %>  
  ...
  <p>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <u><b>
  Return journey Details</b></u></p>
  <p>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Date of 
  Return&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <select size="1" name="rdate">
   <option selected>DD</option>
  <% for(int i=1;i<=31;i++)
	out.println("<option>"+i+"</option>");
%>
   ...
   <option selected>MON</option>
<% String rmonths[]={"jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"};
	java.util.Calendar cmr = java.util.Calendar.getInstance();
	for(int i=0;i<12;i++)
	out.println("<option>"+months[((cm.get(java.util.Calendar.MONTH)+i)%12)]+"</option>");
%>
  ...
  <option selected>YEAR</option>
<% 
	java.util.Calendar cyr = java.util.Calendar.getInstance();
...
%>
 ...
 %>  
  ...
  <p>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input type="submit" value="SUBMIT" name="reservationformforatrip">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
